        ...
        <div class="col-span-4 ">
          <div class="grid grid-cols-5  py-3">
            <div class="cols-span-3">
              ...
              <img src="{{asset('frontent/images/bee.png')}}" alt="" width="70px">
                <span class="font-bold text-2xl font-mono text-white">BeeEnG</span>
              </div>
            </div>
            <div class="cols-span-2 ml-24">
              <div class="flex justify-center ">
                <div class="px-4 py-3 m-2 text-xl text-white font-bold"><a href="">Home</a></div>
                <div class="px-4 py-3 m-2 text-xl text-white font-bold"><a href="">Document</a></div>
